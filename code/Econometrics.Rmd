...
```{r Assign bins to volumes}
a = data.table(Value=volumes$Year_rounded)
...
rounded = b[a, roll='nearest']

rounded <- distinct(rounded)
...
both <- merge(volumes, rounded, by.x = "Year_rounded", by.y = "merge")
